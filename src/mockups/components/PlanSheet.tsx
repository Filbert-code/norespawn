...
// ============================================================================
// Shared bottom sheet that lists a workout's exercises. Used by the Live
// Session "The Plan" queue (with per-row edit controls) and by the Plan
// Library "view" panel (read-only). Keep both visually identical here.
// ============================================================================
...
/** A single exercise row inside a PlanSheet. */
...
/** Default neutral numbered badge for read-only sheets. */
export function PlanSheetNumber({ n }: { n: number }) {
  return (
    <span className="flex size-7 shrink-0 items-center justify-center rounded-full border border-nr-bronze/40 text-xs font-bold text-nr-bone/50">
      {n}
    </span>
  )
}
